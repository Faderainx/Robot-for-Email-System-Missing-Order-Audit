...
def test_mail_filter():
    ...
    filt = MailFilter({"boss@example.com"})
    ...
    mails = [
        ...
        {"subject": "7月账单", "body_text": "见附件", "sender_email": "b@x.com",
         "attachments": [], "skip_reason": None},
        {"subject": "周报", "body_text": "本周情况", "sender_email": "boss@example.com",
         "attachments": [], "skip_reason": None},
        {"subject": "闲聊", "body_text": "中午吃什么", "sender_email": "c@x.com",
         "attachments": [], "skip_reason": None},
        {"subject": "回复: 某某", "body_text": "", "sender_email": "sender@example.com",
        ...
        {"subject": "内部协同", "body_text": "德国WEEE注册", "sender_email": "f@x.com",
         "recipient": "colleague@example.com", "attachments": [], "skip_reason": None},
    ]
    ...
    audit_filter = MailFilter({"audit@example.com"}, audit_mailbox="audit@example.com")
    audit_valid, audit_filtered = audit_filter.filter_mails([{
        "subject": "客户德国WEEE注册", "body_text": "请办理", "sender_email": "customer@example.com",
        "recipient": "audit@example.com", "attachments": [], "skip_reason": None,
    }])
    ...
    alias_valid, alias_filtered = MailFilter(
        set(), audit_mailbox="mailbox@example.com"
    ).filter_mails([{
        "subject": "客户 德国WEEE注册", "body_text": "请办理",
        "sender_email": "customer@example.com",
        "recipient": "report <report@example.com>",
...
def test_field_extractor():
    ...
    agent_map = {
        "agent1@example.com": {"代理": "乐天", "代理简称": "乐天", "收件人邮箱": "agent1@example.com"},
    }
    fx = FieldExtractor(agent_map, project_names=[])  # 附件四为空

    mail = {
        "sender_email": "agent1@example.com",
        "sender_name": "乐天",
    ...
    check("字段输出保留收件人", r.get("recipient") == "audit@example.com", r)
    ...
    code_rows = entity_fx.extract_fields({
        "sender_email": "agent2@example.com", "sender_name": "",
...
def test_llm_intent_mock():
    ...
    f = client.extract_fields_llm("乐天+甲科技+WEEE注册", "", [], "agent@example.com")
    check("extract: 字段映射",
...
def test_workorder_customer_and_agent_guards():
    ...
    from modules.field_extractor import FieldExtractor
    fx = FieldExtractor({
        "agent5@example.com": {"代理": "向善", "代理简称": "向善"},
        "agent4@example.com": {"代理": "向善", "代理简称": "向善"},
    }, project_names=[])
    agent = fx._extract_agent("agent6@example.com", "", "", [])
