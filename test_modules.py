...
def test_mail_filter():
    ...
    test_mails = [
        ...
        {
            "sender_email": "internal@eu-helper.com",
            "subject": "账单确认",
            "body_text": "请确认本月账单金额",
            "attachments": [],
        },
        {
            "sender_email": "huiyan.song@eu-helper.com",
            "subject": "回复: 注册确认",
            "body_text": "已收到",
            "attachments": [],
    ...
    internal_emails = {"internal@eu-helper.com", "huiyan.song@eu-helper.com"}
...
def test_field_extractor():
    ...
    # 测试邮件1: 主题含注册+项目
    mail1 = {
        "sender_email": "account@ctonetech.com",
